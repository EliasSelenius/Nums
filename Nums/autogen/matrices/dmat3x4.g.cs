...
namespace Nums {
    ...
    public struct dmat3x4 {
        ...
        /// </summary>
        public dvec3 col4 {
            readonly get => new dvec3(row1.w, row2.w, row3.w);
            set {
                row1.w = value.x;
                row2.w = value.y;
                row3.w = value.z;
        ...
        /// </summary>
        public readonly dmat4x3 transpose => new dmat4x3(col1, col2, col3, col4);
        /// <summary>
        ...
        /// <summary>
        /// Multiplies a dvec3 with a dmat3x4.
        /// </summary>
        public static dvec4 operator *(dvec3 v, dmat3x4 m ) => new dvec4(m.col1.dot(v), m.col2.dot(v), m.col3.dot(v), m.col4.dot(v));
        /// <summary>
